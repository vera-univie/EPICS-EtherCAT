...
int scantest_registerRecordDeviceDriver(DBBASE *pbase)
{
    ...
    const char *bldTop = "/home/htlrennweg/EPICS/ethercat/iocs/scanTest";
...
/* scantest_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: scantest_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(scantest_registerRecordDeviceDriver(*iocshPpdbbase));
}
