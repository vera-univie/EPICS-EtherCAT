...
/* Generated from ../O.Common/veraBasic.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize, pvar_func_asSub,
    ...
    pvar_func_ecAsynRegistrar, pvar_func_rsrvRegistrar,
...
int veraBasic_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/htlrennweg/EPICS/ethercat/iocs/veraBasic";
    ...
    runRegistrarOnce(pvar_func_ecAsynRegistrar);
...
/* veraBasic_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: veraBasic_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(veraBasic_registerRecordDeviceDriver(*iocshPpdbbase));
}
